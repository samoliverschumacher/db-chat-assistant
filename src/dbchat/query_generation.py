...
documents = {
    1: "table name: employees, fields: name, organisation, manager",
...
def compose_data_retrieval_prompt( users_query: str, context_documents: list[ str ],
                                   datastore_type: datastore_types ) -> str:
    """
...
if __name__ == "__main__":
    ...
    data_retrieval_prompt = compose_data_retrieval_prompt( users_query,
                                                           context_documents,
                                                           datastore_type = datastore_types.SQL )
